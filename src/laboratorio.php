                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Ingrese Marca" name="laboratorio" id="laboratorio" class="form-control">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered" id="tbl">
                        ...
                        <tbody>
                            ...
                            $query = mysqli_query($conexion, "SELECT * FROM laboratorios WHERE estado=0");
