            ...
            <div class="col-md-12">
                ...
                <form action="" method="post" autocomplete="off" id="formulario">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="direccion" class="text-dark font-weight-bold">CI</label>
                                <input type="text" placeholder="Ingrese CI" name="direccion" id="direccion" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered" id="tbl">
                        ...
                        <tbody>
                            ...
                            $query = mysqli_query($conexion, "SELECT * FROM cliente WHERE estado=0");
                                ...
                                while ($data = mysqli_fetch_assoc($query)) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="detalle_producto.php?id=<?php echo $data['idcliente']; ?>"  class="btn btn-default">Producto</a>
